...
int main(int argc, char** argv)
{
  ...
  if (plan == true)
  {
    ...
    table_spot_1.linear() = Eigen::Quaterniond(0, 0, 1, 0).matrix();
    table_spot_1.translation() = Eigen::Vector3d(0, 0.6, 0.77153 + box_size_z + gripper_offset - 0.05);  //0.77153 table height

    // Set the target pose to middle_right_shelf
    final_pose = table_spot_1;
    ...
    config_place.params.max_iter = 1000;
